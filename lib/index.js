...
module.exports = {
  ...
  kitty:        require('./formats/kitty'),
  konsole:      require('./formats/konsole'),
  linux:        require('./formats/linux'),
  lxterminal:   require('./formats/lxterminal'),
  ...
  tilix:        require('./formats/tilix'),
  wal:          require('./formats/wal'),
  winterminal:  require('./formats/winterminal'),
